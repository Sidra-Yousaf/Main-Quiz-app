...
import React__default, { HTMLAttributes, RefObject, ComponentProps, ReactNode, FunctionComponent, ReactElement, CSSProperties } from 'react';
...
interface AnimationProps extends BaseComponent {
    ...
    animationRef?: React__default.RefObject<HTMLElement>;
    delay?: number;
    duration?: number;
    ...
    setTarget?: React__default.SetStateAction<any>;
    tag?: React__default.ComponentProps<any>;
    target?: boolean;
}

declare const MDBAnimation: React$1.FunctionComponent<AnimationProps>;
...
interface DateTimepickerProps extends BaseComponent {
    label?: string;
...
declare const MDBDateTimepicker: FunctionComponent<DateTimepickerProps>;
...
declare type AdvancedRecord = Record<string, unknown> & {
    rowSelector?: string;
};
declare type AdvancedHeader = {
    label: string;
...
declare type HeaderType = string | AdvancedHeader;
declare type RecordsType = unknown[] | AdvancedRecord;
declare type ColumnsType = HeaderType[];
declare type RowsType = RecordsType[];
...
interface DatatableProps extends BaseComponent {
    ...
    format?: (field: string | number | symbol, value: number) => CSSProperties | undefined;
...
declare type videoProps$1 = React__default.VideoHTMLAttributes<HTMLVideoElement>;
declare type LazyLoadingProps = imgProps$1 & videoProps$1 & {
...
declare type animationList$1 = 'fade-in' | 'fade-in-down' | 'fade-in-left' | 'fade-in-right' | 'fade-in-up' | 'fade-out' | 'fade-out-down' | 'fade-out-left' | 'fade-out-right' | 'fade-out-up' | 'slide-in-down' | 'slide-in-left' | 'slide-in-right' | 'slide-in-up' | 'slide-out-down' | 'slide-out-left' | 'slide-out-right' | 'slide-out-up' | 'slide-down' | 'slide-left' | 'slide-right' | 'slide-up' | 'zoom-in' | 'zoom-out' | 'tada' | 'pulse' | 'drop-in' | 'drop-out' | 'fly-in' | 'fly-in-up' | 'fly-in-down' | 'fly-in-left' | 'fly-in-right' | 'fly-out' | 'fly-out-up' | 'fly-out-down' | 'fly-out-left' | 'fly-out-right' | 'browse-in' | 'browse-out' | 'browse-out-left' | 'browse-out-right' | 'jiggle' | 'flash' | 'shake' | 'glow';
...
declare const MDBChipsInput: React.FunctionComponent<ChipsInputProps>;
...
interface SelectV2Props extends Omit<React__default.AllHTMLAttributes<HTMLElement>, 'size' | 'data'> {
