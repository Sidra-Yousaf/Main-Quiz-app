...
$timepicker-head-background-color: $primary !default;
...
$timepicker-button-color: $primary !default;
...
$timepicker-time-tips-inner-active-background-color: $primary !default;
...
$timepicker-item-middle-dot-background-color: $primary !default;

$timepicker-hand-pointer-background-color: $primary !default;
...
$popconfirm-border: 1px solid #f5f5f5 !default;
...
$perfectScrollbar-ps-ps__rail-x-y-transition-opacity-bg: background-color 0.2s linear, opacity 0.2s linear !default;
$perfectScrollbar-ps-ps__rail-x-transition-height-bg: background-color 0.2s linear, height 0.2s ease-in-out !default;
$perfectScrollbar-ps-ps__rail-y-transition-width-bg: background-color 0.2s linear, width 0.2s ease-in-out !default;
...
$chip-font-color: $body-color !default;
...
$form-outline-select-dropdown-box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12) !default;
...
$form-outline-select-option-hover-not-disabled-bgc: rgba(0, 0, 0, 0.048) !default;
$form-outline-select-option-active-bgc: rgba(0, 0, 0, 0.048) !default;
$form-outline-select-option-selected-active-bgc: rgba(0, 0, 0, 0.048) !default;
$form-outline-select-option-selected-disabled-color: #9e9e9e !default;
$form-outline-select-option-selected-bgc: rgba(0, 0, 0, 0.02) !default;
