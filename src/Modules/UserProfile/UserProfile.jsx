              ...
              <MDBCard className="card">
                <div className="card-body text-center">
                  ...
                  <p className="mb-2 text-muted">
                    ...
                    Quia deserunt pariatur voluptatem consequuntur! Aliquid,
                    placeat nobis odit delectus ad est, nemo repudiandae
                    possimus repellendus voluptas debitis, numquam modi
                    asperiores beatae?
                  </p>
                </div>
              </MDBCard>
